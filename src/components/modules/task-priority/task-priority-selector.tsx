...
const TaskPrioritySelector = React.forwardRef<
    HTMLButtonElement,
...
>(
    (
        ...
        const {
            ...
            queryKey: ["projects", projectId, "task-priorities"],
            queryFn: () => getProjectTaskPriorities(projectId),
        });
